...
| 来源旧包 | 吸收落点 |
| --- | --- |
| `sdlc-speckit-tasks` | Core Rules 全部条款吸收至本包 Core Rules 清单；references 迁移件 4 个文件见 `references/sdlc-speckit-tasks/` |
| `sdlc-speckit-analyze` | Core Rules 全部条款吸收至本包 Core Rules 清单；references 迁移件 5 个文件见 `references/sdlc-speckit-analyze/` |
