...
blocking_conditions:
  ...
  - naming drift detected (document naming does not follow project convention)
  - shape drift detected (document shape differs from sibling L4)
  ...
  - flags active specs cleanup / unsafe archive / missing traceability
```
