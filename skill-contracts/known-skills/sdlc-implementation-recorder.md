# sdlc-implementation-recorder Skill Contract
...
`sdlc-implementation-recorder` 是实现记录生成器。
...
- 修改业务代码。
- 审阅代码质量以替代 `sdlc-code-review-normalizer` 或 Reviewer。
- 补写技术方案。
- 自动接受风险。
- 将聊天片段或未验证猜测写成实现事实。
...
- Blocking Issues
- Change History
- Next Step: run `sdlc-code-review-normalizer` or resolve blockers
