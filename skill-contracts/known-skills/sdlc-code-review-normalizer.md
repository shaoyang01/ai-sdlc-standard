# sdlc-code-review-normalizer Skill Contract
...
`sdlc-code-review-normalizer` 将 DeepSeek、Codex、人工或其他 Reviewer 的代码审查输出归一成可执行的 Code Review Report。
...
- 凭空补造规格依据。
- 将 Review 建议扩大成新需求。
- 替代 `sdlc-test-feedback-sync` 处理测试反馈。
