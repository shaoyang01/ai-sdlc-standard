...
34. **Hermes Gateway Real Dispatch Phase-2 Validation Checklist** — next safe step
35. **Controlled Skill Flow Routing / Governance** — Memory-aware routing with audit trail
36. **Graph Kernel Alignment** — code-review / bugfix as lifecycle nodes
