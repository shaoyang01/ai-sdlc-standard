...
32. **Hermes Gateway Real Dispatch Post-Enablement Review Template** — next safe step
33. **Controlled Skill Flow Routing / Governance** — Memory-aware routing with audit trail
34. **Graph Kernel Alignment** — code-review / bugfix as lifecycle nodes
