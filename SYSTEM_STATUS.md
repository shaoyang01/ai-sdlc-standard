...
35. **Hermes Gateway Real Dispatch Phase-2 Operator Runbook** — next safe step
36. **Controlled Skill Flow Routing / Governance** — Memory-aware routing with audit trail
37. **Graph Kernel Alignment** — code-review / bugfix as lifecycle nodes
