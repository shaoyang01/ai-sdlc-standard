...
| [Decision-056](Decision-056-c03d-runtime-integration-artifact-path-migration.md) | 2026-08-26 | DRAFT | C03-D Runtime Integration & Artifact Path Migration 授权草案（c1/c2/c3 接入 runtime 调度路径 + 制品路径常量迁移到 WP3.5 新编号）；待 Current User 裁决。 |
