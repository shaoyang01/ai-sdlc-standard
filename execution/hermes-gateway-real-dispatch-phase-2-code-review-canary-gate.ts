...
export function createHermesPhase2CodeReviewCanaryGate(config: Readonly<{
  ...
  const gate: HermesPhase2CodeReviewCanaryGate = {
    claim(
      ...
      // Step 12: verifier must synchronously return true
