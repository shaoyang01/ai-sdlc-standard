...
export const SKILL_FLOW_REGISTRY: ReadonlyArray<SkillFlowBinding> = [
  ...
  // ── Direct Implementation Path ──────────────────────
  {
    ...
    primaryOutputArtifacts: ["Code changes", "library/{id}/03-实现记录/"],
  ...
  },
  {
    ...
    primaryOutputArtifacts: ["Review findings", "library/{id}/04-代码审核/"],
  ...
  },
  {
    ...
    primaryOutputArtifacts: [".specify/business_domain/**", "Drift Matrix", "Sync recommendations", "library/{id}/05-测试验收/"],
