...
The next intended PR is Hermes Gateway Real Dispatch Phase-2 Final Readiness Review. The phase-2 operator runbook remains non-executing, requires operator approval, and blocks automatic enablement.
