...
The next intended PR is Hermes Gateway Real Dispatch Phase-2 Shadow Enablement Readiness Gate. The phase-2 shadow enablement rollback contract remains non-executing, requires operator approval, and blocks automatic enablement.
