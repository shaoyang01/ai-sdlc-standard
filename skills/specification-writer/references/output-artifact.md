...
2. Use `docflow-writer` for output routing, rendering, and publishing.
...
Activity Log:
  Actor / Skill: specification-writer
  Action: generate technical specification
  Node: 01-技术方案
  Result: ready-for-solution-review

Next Step:
  Run solution-reviewer
```

## Ready-for-Review Criteria

A specification is ready for `solution-reviewer` when:
