...
- Required Actions from `solution-reviewer` are unresolved.
...
- `specification-writer` for technical specification revisions.
- `solution-reviewer` for renewed Specification Gate.
- `gate-runner` for checking readiness after updates.
