...
## Manifest Sync Record Recommendation

For a single-rail sync, recommend updating the manifest `business_domain_sync` record:
...
business_domain_sync:
  ...
  current_sync_owner: sdlc-knowledge-sync
