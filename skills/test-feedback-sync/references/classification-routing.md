...
| Specification Missing | Return to `01-技术方案` and rerun `solution-reviewer`. | Recommend Specification Checklist or Schema update when the missing rule is reusable. | Sync only after new Gate passes. |
