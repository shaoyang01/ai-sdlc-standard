...
| Specification Gate | Development path routing or implementation planning | `01-技术方案` and `02-方案审核` | Missing specification, `solution-reviewer` FAIL, missing risk acceptance |
...
- `SPECKIT_PIPELINE_REQUIRED` should route to `speckit-pipeline-confirmed-single`, not direct implementation.
