...
| 来源旧包 | 吸收落点 |
| --- | --- |
| `sdlc-solution-challenger` | Core Rules 全部条款吸收至本包（迁移件已随吸收完成移除） |
| `sdlc-solution-reviewer` | Core Rules 全部条款吸收至本包（迁移件已随吸收完成移除） |
| `sdlc-speckit-clarify` | Core Rules 全部条款吸收至本包（迁移件已在 C03-E E0.1 全部退役删除） |
