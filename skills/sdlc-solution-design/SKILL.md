...
11. GAR 五要素自检覆盖：业务目标 / 用户意图 / 当前问题 / 初步范围 / 不确定点逐一建模；共享合同全文见 `${AI_SDLC_STANDARD_HOME}/ai-sdlc/goal-anchored-global-reasoning.md`。

## 能力来源对照表

| 来源旧包 | 吸收落点 |
| --- | --- |
| `sdlc-specification-writer` | Core Rules 全部条款吸收至本包（迁移件已随吸收完成移除） |
| `sdlc-speckit-specify` | Core Rules 全部条款吸收至本包（迁移件已随吸收完成移除） |
| `sdlc-speckit-plan` | Core Rules 全部条款吸收至本包（迁移件已随吸收完成移除） |
