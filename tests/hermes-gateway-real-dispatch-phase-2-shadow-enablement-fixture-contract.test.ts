...
async function test() {
  ...
  const md = fs.readFileSync("HERMES_GATEWAY_REAL_DISPATCH_PHASE_2_SHADOW_ENABLEMENT_FIXTURE_CONTRACT.md", "utf-8");
  ...
  const jr = fs.readFileSync("hermes-gateway-real-dispatch-phase-2-shadow-enablement-fixture-contract.json", "utf-8");
