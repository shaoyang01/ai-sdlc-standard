...
async function test() {
  ...
  // ── Test 11: retired skill registry bindings (metadata-only) ──
  // C03-B: sdlc-solution-challenger and sdlc-solution-reviewer semantic invariant
  // tests removed — both skills retired and absorbed into sdlc-solution-gate.
  // Registry binding assertions for 21 legacy IDs remain (C03-C scope).
  console.log("Test 11: retired skill registry bindings (metadata-only)");
