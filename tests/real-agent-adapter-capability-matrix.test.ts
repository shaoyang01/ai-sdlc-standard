...
async function test() {
  ...
  assert(hermes["gateway_real_dispatch_phase_2_shadow_enablement_observability_contract_recommended_next_pr"] === "Hermes Gateway Real Dispatch Phase-2 Shadow Enablement Guardrail Contract", "hermes dispatch phase-2 shadow enablement observability contract next PR");
  ...
  assert(m.recommended_next_pr.title === "Hermes Gateway Real Dispatch Phase-2 Shadow Enablement Guardrail Contract", "next PR phase-2 shadow enablement guardrail contract");
  console.log("");
