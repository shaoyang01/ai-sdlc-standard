...
async function test() {
  ...
  assert(hermes["gateway_real_dispatch_phase_2_shadow_enablement_contract_recommended_next_pr"] === "Hermes Gateway Real Dispatch Phase-2 Shadow Enablement Observability Contract", "hermes dispatch phase-2 shadow enablement contract next PR");
  ...
  assert(hermes["gateway_real_dispatch_phase_2_shadow_enablement_test_plan_recommended_next_pr"] === "Hermes Gateway Real Dispatch Phase-2 Shadow Enablement Observability Contract", "hermes dispatch phase-2 shadow enablement test plan next PR");
  ...
  assert(hermes["gateway_real_dispatch_phase_2_shadow_enablement_fixture_contract_recommended_next_pr"] === "Hermes Gateway Real Dispatch Phase-2 Shadow Enablement Observability Contract", "hermes dispatch phase-2 shadow enablement fixture contract next PR");
  ...
  assert(m.recommended_next_pr.title === "Hermes Gateway Real Dispatch Phase-2 Shadow Enablement Observability Contract", "next PR phase-2 shadow enablement observability contract");
  console.log("");
